...
void example_H_to_hh_to_4Wlnu(const std::string& output_name = "output_example_04.root"){
  ...
  for(int igen = 0; igen < Ngen; igen++){
    ...
    Laa_R.SetLabFrameFourVector(Laa_G.GetFourVector());
    Lab_R.SetLabFrameFourVector(Lab_G.GetFourVector());
    Lba_R.SetLabFrameFourVector(Lba_G.GetFourVector());
    Lbb_R.SetLabFrameFourVector(Lbb_G.GetFourVector());
